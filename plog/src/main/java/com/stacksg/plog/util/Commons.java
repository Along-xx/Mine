...
public class Commons {
	...
	public static Map<String,String> social(){
		...
		map.put("weibo", PlogConst.OPTIONS.get(prefix+"weibo"));
		map.put("zhihu", PlogConst.OPTIONS.get(prefix+"zhihu"));
		map.put("github", PlogConst.OPTIONS.get(prefix+"github"));
		map.put("twitter", PlogConst.OPTIONS.get(prefix+"twitter"));
		if(StrUtil.isNotEmpty(PlogConst.OPTIONS.get(prefix+"qq"))) {
			map.put("qq", "http://wpa.qq.com/msgrd?v=3&uin="+ PlogConst.OPTIONS.get(prefix+"qq")+"&site=qq&menu=yes");
		}
		if(StrUtil.isNotEmpty(PlogConst.OPTIONS.get(prefix+"email"))) {
			map.put("email", "mailto:"+ PlogConst.OPTIONS.get(prefix+"email"));
		}
		if("rss_open".equals(PlogConst.OPTIONS.get(prefix+"rss"))) {
				map.put("rss", PlogConst.OPTIONS.get("blog_url")+"/index.xml");
		}
		return map;
	}
}
