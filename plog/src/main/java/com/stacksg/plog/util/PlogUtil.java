...
public class PlogUtil {
	...
	public static String buildRss(List<ArticleCustom> articles)throws FeedException{
		 ...
		 if(PlogConst.OPTIONS.get("blog_name")==null) {
			 channel.setTitle("");
		 }else {
			 channel.setTitle(PlogConst.OPTIONS.get("blog_name"));
		 }
		 if(PlogConst.OPTIONS.get("blog_url")==null) {
			 channel.setLink("");
		 }else {
			 channel.setLink(PlogConst.OPTIONS.get("blog_url"));
		 }
		 if(PlogConst.OPTIONS.get("blog_url")==null) {
			 channel.setUri("");
		 }else {
			 channel.setUri(PlogConst.OPTIONS.get("blog_url"));
		 }
		 if(PlogConst.OPTIONS.get("seo_describe")==null) {
			 channel.setDescription("");
		 }else {
			 channel.setDescription(PlogConst.OPTIONS.get("seo_describe"));
		 }
		...
		for (int i = 0; i < articles.size(); i++) {
			...
			item.setLink(PlogConst.OPTIONS.get("blog_url")+"/post/"+articles.get(i).getArticleUrl());
