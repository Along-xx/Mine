...
import com.stacksg.plog.model.enums.ThemeStatus;
import com.stacksg.plog.service.*;
...
public class InstallController extends BaseController{
	...
	public JsonResult execute(@RequestParam(value = "blogName") String blogName,
		...
		article.setArticleTitle("Hello plog!");
		article.setArticleContentMd("# Hello plog!\n" +
                    "欢迎使用plog进行创作，删除这篇文章后赶紧开始吧。");
		...
		article.setArticleSummary("欢迎使用plog进行创作，删除这篇文章后赶紧开始吧。");
		...
		article.setArticleUrl("hello-plog");
