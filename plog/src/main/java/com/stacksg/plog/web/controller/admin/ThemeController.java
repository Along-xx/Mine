...
import com.stacksg.plog.model.domain.Theme;
...
public class ThemeController extends BaseController {
	...
	public JsonResult saveTheme(Theme theme, HttpServletRequest request) {
		try {
			...
			if (th != null) {
				return new JsonResult(PlogEnums.PRESERVE_ERROR.isFlag(), "该主题已存在");
			}
			...
			return new JsonResult(PlogEnums.PRESERVE_ERROR.isFlag(), PlogEnums.PRESERVE_ERROR.getMessage());
		}
