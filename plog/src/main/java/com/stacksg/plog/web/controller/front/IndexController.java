package com.stacksg.plog.web.controller.front;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.github.pagehelper.PageInfo;
import com.stacksg.plog.model.domain.*;
import com.stacksg.plog.model.dto.ArchiveBo;
import com.stacksg.plog.model.dto.PlogConst;
import com.stacksg.plog.model.enums.ArticleStatus;
import com.stacksg.plog.model.enums.PageNumber;
...
import com.stacksg.plog.service.LinksService;
import com.stacksg.plog.service.TagService;
import com.stacksg.plog.util.PlogUtil;
import com.stacksg.plog.web.controller.admin.BaseController;
...
public class IndexController extends BaseController {
	...
	public String index(Model model, @PathVariable(value = "page") Integer page) {
		//如果page超出[0,100]范围则默认显示第一页
		page = page < 0 || page > PlogConst.MAX_PAGE ? 1 : page;
		// 默认显示条数
		Integer limit = StrUtil.isEmpty(PlogConst.OPTIONS.get("index_article")) ? PageNumber.POST_INDEX_lIMIT.getLimit()
				: Integer.parseInt(PlogConst.OPTIONS.get("index_article"));
		//首页默认加载已发布和post类型文章
	...
	public boolean checkRepeatIp(HttpServletRequest request, int id) {
		...
		cache.hset("hits:frequency", value, 1, PlogConst.IP_REPEAT_TIME);
		return false;
	}
	...
	public void updateArticleViews(Integer id, Long views) {
		...
		if (cacheViews >= PlogConst.CLICK_EXCEED) {
	...
	public String rss() throws FeedException {
		String rssNumber = PlogConst.OPTIONS.get("rss_number");
		...
		return PlogUtil.buildRss(articles);
	}
